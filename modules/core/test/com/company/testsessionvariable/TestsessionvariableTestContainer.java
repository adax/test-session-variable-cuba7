package com.company.testsessionvariable;
...
public class TestsessionvariableTestContainer extends TestContainer {

    public TestsessionvariableTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/testsessionvariable/app.properties",
    ...
    public static class Common extends TestsessionvariableTestContainer {

        public static final TestsessionvariableTestContainer.Common INSTANCE = new TestsessionvariableTestContainer.Common();
